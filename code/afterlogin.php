...
if (isset($_SESSION['privilleged'])) {
    ...
    // If the user is not logged in, display the "Sign Up" and "Sign In" buttons
    $userNavigation = '<div class="auth">
...
<body>
    <header>
        <nav class="navbar">
            ...
            <div class="auth">
                <a button id="logout-btn" type="submit" name="logout" href="index.php"
                    style="background-color: red; color: white; padding: 10px 20px; text-decoration: none;">LogOut</a>
            </div>
